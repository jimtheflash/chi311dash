# Getting help with chi311dash

Thanks for using chi311dash. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/chi311dash/issues) to make sure the 
